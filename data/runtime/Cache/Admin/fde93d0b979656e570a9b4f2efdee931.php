...
<body>
	<div class="wrap js-check-wrap">
		...
		<ul class="nav nav-tabs pointUl">
			<li class="active"><a href="<?php echo U('Structural/index',array('project_id'=>$info['id']));?>">平面图</a></li>
			<li><a href="<?php echo U('Structural/zyinfolist',array('project_id'=>$info['id']));?>">各专业条件图<?php if($zyncount > 0): ?><span class="pointred">.</span><?php endif; ?></a></li>
		...
		<fieldset>
				...
				<tbody>
					<?php if(is_array($firstpic)): $i = 0; $__LIST__ = $firstpic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i; if($val['filename'] != ''): ?><tr>						
						...
						<td style="text-align: center;">
							<a href="<?php echo U('Structural/download',array('id'=>$val['id']));?>" class="btn" style="background:#1abc9c">下载</a>
			...
			<form class="form-horizontal" name="tagforms3" method="post" enctype="multipart/form-data" action="<?php echo U('Structural/index');?>">
			<fieldset>
    ...
    function show_div2(projectid,ids,mid) {     
        ...
        $.ajax({
        	url:"<?php echo U('Admin/Structural/getmessageinfo');?>",
