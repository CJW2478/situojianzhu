...
<div class="wrap js-check-wrap">
	...
	<ul class="nav nav-tabs pointUl">
		<li class="active"><a href="<?php echo U('Distribution/index',array('project_id'=>$principal['id']));?>">甲方项目基本信息</a></li>
		<li><a href="<?php echo U('Distribution/solutions',array('project_id'=>$principal['id']));?>">分配方案师<?php if($sign["solutions"] > 0): ?><span class="pointred">.</span><?php endif; ?></a></li>
		<li><a href="<?php echo U('Distribution/professional',array('project_id'=>$principal['id']));?>">分配各专业人员<?php if($sign["professional"] > 0): ?><span class="pointred">.</span><?php endif; ?></a></li>
		<li><a href="<?php echo U('Distribution/work_plan',array('project_id'=>$principal['id']));?>">上传施工图所需资料</a>
		<li><a href="<?php echo U('Distribution/opinion',array('project_id'=>$principal['id']));?>">上传施工图审查意见（内部、外部）</a></li>
	</ul>
		...
		<fieldset>
			...
			<table class="table table-hover table-bordered" style="width: 800px;margin-left:90px;">
				...
				<?php if(is_array($project)): $i = 0; $__LIST__ = $project;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
						...
						<td style="text-align: center;"><a href="<?php echo U('Distribution/downloadbase',array('id'=>$val['id']));?>" class="btn" style="background:#1abc9c">下载</a></td>
					</tr><?php endforeach; endif; else: echo "" ;endif; ?>
				<?php if($count == 0): ?><tr><td colspan="4" style="text-align: center;">暂无上传资料</td></tr><?php endif; ?>
				</tbody>
			</table>
