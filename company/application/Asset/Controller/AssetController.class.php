...
class AssetController extends AdminbaseController {
    ...
    public function plupload(){
        ...
        if (IS_POST) {
            ...
            file_put_contents('a333.txt',var_export($all_allowed_exts,true));
            ...
            file_put_contents('a3331111.txt',var_export($upload_max_filesize,true));
            $app=I('post.app/s','');
			...
			$info=$upload->upload();
			file_put_contents('a3331.txt',var_export($info,true));
            //开始上传
            if ($info) {
                //上传成功
				...
				file_put_contents('a33312.txt',var_export($upload->getError(),true));
