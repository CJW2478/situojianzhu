...
class iAuth{
    ...
    public function check($uid,$name,$relation='or') {
        ...
        $role_user_model=M("CroleUser");
        
        $role_user_join = '__CROLE__ as b on a.role_id =b.id';
        ...
        $auth_access_model=M("CauthAccess");
        
        $join = '__CAUTH_RULE__ as b on a.rule_name =b.name';
    ...
    private function getUserInfo($uid) {
    	...
    	if(!isset($userinfo[$uid])){
    		$userinfo[$uid]=M("company")->where(array('id'=>$uid))->find();
    	}
    	return $userinfo[$uid];
    }
