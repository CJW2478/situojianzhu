...
class SolutionsModel extends CommonModel
{
    ...
    public function getData($where,$page)
    {
        $data = M('solutions as a ')
            ...
            ->field('a.remark,a.status,a.create_time,a.role_id,a.distribution,a.role_name,a.by_distribution,a.project_id,
            a.id,b.user_name distribution_name,c.mobile,c.qq_no,c.wx_no,c.user_duty,c.user_name solution_name')
            ->where($where)
