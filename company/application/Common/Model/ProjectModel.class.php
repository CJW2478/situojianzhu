...
class ProjectModel extends CommonModel
{
    protected $_validate = array(
        ...
        array('project_name', 'require', '项目名称不能为空！', 0, 'regex', CommonModel:: MODEL_BOTH ),
        array('project_no', 'require', '项目编号不能为空！', 0, 'regex', CommonModel:: MODEL_BOTH ),
        array('company_id', 'require', '所属公司不能为空！', 0, 'regex', CommonModel:: MODEL_BOTH ),
        array('principal_name', 'require', '甲方项目负责人不能为空！', 0, 'regex', CommonModel:: MODEL_BOTH ),
        array('duty', 'require', '甲方负责人职务不能为空！', 0, 'regex', CommonModel:: MODEL_BOTH ),
        array('mobile', 'require', '甲方负责人电话不能为空！', 0, 'regex', CommonModel:: MODEL_BOTH ),
        array('project_name', '0,30', '项目名称过长！', 2, 'length', CommonModel:: MODEL_BOTH ),
        array('project_name', '0,16', '项目编号过长！', 2, 'length', CommonModel:: MODEL_BOTH ),
        ...
        array('project_name', '', '该项目已创建！', 1, 'unique', CommonModel:: MODEL_INSERT ),
