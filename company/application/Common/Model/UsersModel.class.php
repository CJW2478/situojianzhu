...
class UsersModel extends CommonModel
{
	protected $_validate = array(
        ...
        array('user_name', '/^([\x{4e00}-\x{9fa5}]{0,10}$)/u', '请输入正确的用户名称！', 1, 'regex', CommonModel:: MODEL_BOTH ),
        ...
        array('user_name', '/^([\x{4e00}-\x{9fa5}]{0,6}$)/u', '请输入正确的职务名称！', 1, 'regex', CommonModel:: MODEL_BOTH ),
		array('user_duty', '0,6', '职务字符数超限！', 1, 'length', CommonModel:: MODEL_BOTH),
	    ...
	    array('mobile','','该手机号已注册！',1,'unique',CommonModel:: MODEL_INSERT ), // 验证mobile字段是否唯一
	);
