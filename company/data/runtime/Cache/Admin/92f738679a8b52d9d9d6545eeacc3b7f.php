...
<meta charset="utf-8">
<title>思拓建筑设计 <?php echo L('ADMIN_CENTER');?></title>
...
<link href="/company/public/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css?page=index"  rel="stylesheet" type="text/css">
<!--[if IE 7]>
	<link rel="stylesheet" href="/company/public/simpleboot/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
<![endif]-->
<link rel="stylesheet" href="/company/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<link href="/company/public/js/artDialog/skins/default.css" rel="stylesheet" />
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/company/public/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<a href="<?php echo U('admin/index/index');?>" class="brand"> <small> 
					思拓建筑设计<?php echo L('ADMIN_CENTER');?>
				</small>
				</a>
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							...
							<?php else: ?>
								<img class="nav-user-photo" width="30" height="30" src="/company/admin/themes/simplebootx/Public/assets/images/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>"><?php endif; ?>
							<span class="user-info">
								<?php echo L('WELCOME_USER',array('username'=>$admin['user_login']));?>
							</span>
							<i class="fa fa-caret-down"></i>
						</a>

						<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">	
							<li><a href="javascript:openapp('<?php echo U('setting/password');?>','index_password','修改密码');"><i class="fa fa-lock"></i>修改密码</a></li>
	...
	<script src="/company/admin/themes/simplebootx/Public/assets/js/index.js"></script>
</body>
</html>